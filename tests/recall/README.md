...
| 2026-09-23 | `681b2d8` | minilm-l6-v2   | `locomo-gate` + per-case, 5 repeats, **cross-encoder on** (workflow run 35891724716). First baseline recorded with `SHODH_CE_RERANK=1`, the configuration the server ships since #562 and the gate measures since #563. 43 cases moved: 14 gained gold, 3 lost gold (q125, q30, q43), p@1 +13/−1 (q62), 12 rank-only. recall@10 0.5618 → 0.6368, ndcg@10 0.4248 → 0.5409, mrr 0.4042 → 0.5372, p@1 0.31 → 0.46. |
