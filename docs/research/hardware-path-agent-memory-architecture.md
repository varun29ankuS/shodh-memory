...
- *Neuromorphic Principles for Efficient LLMs on Intel Loihi 2* — arXiv:2503.18002 (preliminary per authors; extent of on-hardware measurement unclear — treated as PROJECTED)
